...
import system.entity.CartEntity;
import system.entity.ProductEntity;

/**
 * Created by Qubo on 20.06.2017.
 */
public class HibernateUtil {
    ...
    static {
        try {
            ...
            ac.addAnnotatedClass(ProductEntity.class).addAnnotatedClass(CartEntity.class);
//                    .addAnnotatedClass(CableEntity.class)
